...
### 22.1 ToDoList��������ִ�У�
- [ ] ���� lib/app-logger.ts��ʵ�ֱ�����־�洢����ȡ����ա�������ʽ����
- [ ] �� pp/_layout.tsx ��ʼ����־ϵͳ���ӹ� console.log/warn/error��
- [ ] �� pp/(tabs)/settings.tsx ������־���򣨲鿴����ա���������
- [ ] �����־�鿴 Modal���ɹ�������ˢ�£���
- [ ] ���� pnpm run check ���޸��������ʹ���
### 22.2 ִ�н��
- [x] lib/app-logger.ts �������������־�洢/��ȡ/���/��ʽ����
- [x] pp/_layout.tsx �ѽ�����־��ʼ���� console ����
- [x] pp/(tabs)/settings.tsx ��������־��ڣ��鿴/���/��������
- [x] ��־�鿴 Modal �ѿɹ�����֧��ˢ�¡�
- [x] pnpm run check ��ͨ����
...
### 23.1 ToDoList��������ִ�У�
- [ ] �޸��˳���¼���Ա��ְ��˺ŵ����⣨server device-login �������ˣ���
- [ ] �޸�����Ͷ��ҳƵ�����⣨submit-story ��ʼ�� effect ������������
- [ ] �޸� APK �����Ǳ��̲��ɼ����⣨game ҳȥ�� __DEV__ ���ƣ���
- [ ] ���� BUG.md ��Ӧ��Ŀ״̬���޸���¼��
- [ ] ���� pnpm run check ��ȷ��ͨ����
### 23.2 ִ�н��
- [x] ���޸��˳���¼���Ա��ְ��˺ŵ����⣨������������ˣ���
- [x] ���޸�����Ͷ��ҳƵ�����⣨`submit-story` effect ������������
- [x] ���޸� APK �����Ǳ��̲��ɼ����⣨ȥ�� `__DEV__` ���ƣ���
- [x] �Ѹ��� `BUG.md` �޸���¼��
- [x] `pnpm run check` ͨ����
- [x] `server/pnpm run build` ͨ����
